...
namespace Moonvalk.Data
{
    ...
    public class MoonGameSettings : MoonSaveFile
    {
        ...
        protected void SetDefaults()
        {
            ...
            AddSaveData("fullscreen", new BaseMoonSaveData<bool>()).SetValue(("Enabled", false));

            AddSaveData("graphics", new BaseMoonSaveData<float>()).SetValue(("Screenshake", 0.5f), ("Bloom", 0.5f));
        }
