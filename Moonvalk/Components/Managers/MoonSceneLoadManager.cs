...
namespace Moonvalk.Components
{
    ...
    public class MoonSceneLoadManager : Node
    {
        ...
        public void LoadScene(string sceneName_, Action onLoad_ = null)
        {
            ...
            {
                TransitionController.PlayTransitionIntro(() => { StartSceneLoad(sceneName_, onLoad_); });
                return;
            }
        ...
        {
            MoonResourceLoader.Load(GetScenePath(sceneName_), (PackedScene scene_) => { InstanceScene(scene_, onLoad_); }, initialPollDelay_: 1f);
        }
