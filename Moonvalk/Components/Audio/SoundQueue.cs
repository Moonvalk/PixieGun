...
namespace Moonvalk.Audio
{
    ...
    public class SoundQueue : Node
    {
        ...
        public override void _Ready()
        {
            ...
            if (!(child is AudioStreamPlayer audioStreamPlayer)) return;
        ...
        public override string _GetConfigurationWarning()
        {
            ...
            return !GetChild(0).IsType<AudioStreamPlayer>() ? "Expected first child to be an AudioStreamPlayer." : "";
        }
        ...
        {
            if (AudioStreamPlayers[NextIndex].Playing) return;
