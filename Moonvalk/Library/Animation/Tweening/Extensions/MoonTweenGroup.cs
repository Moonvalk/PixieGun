...
namespace Moonvalk.Animation {
	...
	public class MoonTweenGroup {
		...
		/// </summary>
		public Dictionary<MoonTweenProperty, IMoonTweenHandler> TweenHandlers { get; private set; }
		...
		public MoonTweenGroup() {
			this.TweenHandlers = new Dictionary<MoonTweenProperty, IMoonTweenHandler>();
		}
		...
		public BaseMoonTween<Unit> AddTween<ParentType, Unit>(
			ParentType object_,
		...
		public IMoonTween<Unit> GetTween<Unit>(MoonTweenProperty property_) {
			if (this.TweenHandlers.ContainsKey(property_)) {
				return this.TweenHandlers[property_]?.GetTween<Unit>();
			}
			return null;
		}
