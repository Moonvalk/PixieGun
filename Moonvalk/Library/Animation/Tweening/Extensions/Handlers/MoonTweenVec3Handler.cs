...
namespace Moonvalk.Animation
{
    ...
    public class MoonTweenVec3Handler<ParentType> : BaseMoonTweenHandler<Vector3, MoonTweenVec3, ParentType>
    {
        ...
        /// </param>
        public MoonTweenVec3Handler(ParentType object_, MoonTweenProperty property_, Vector3 target_, MoonTweenParams parameters_, bool start_,
        ...
        {
            Tween = new MoonTweenVec3 { StartOnTargetAssigned = start_ };
            Tween.SetReferences(() => ref _values[0], () => ref _values[1], () => ref _values[2]).SetParameters(parameters_);
