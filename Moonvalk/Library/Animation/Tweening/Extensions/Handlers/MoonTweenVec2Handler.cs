...
namespace Moonvalk.Animation
{
    ...
    public class MoonTweenVec2Handler<ParentType> : BaseMoonTweenHandler<Vector2, MoonTweenVec2, ParentType>
    {
        ...
        /// </param>
        public MoonTweenVec2Handler(ParentType object_, MoonTweenProperty property_, Vector2 target_, MoonTweenParams parameters_, bool start_,
        ...
        {
            Tween = new MoonTweenVec2 { StartOnTargetAssigned = start_ };
            Tween.SetReferences(() => ref _values[0], () => ref _values[1]).SetParameters(parameters_);
