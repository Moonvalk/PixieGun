...
namespace Moonvalk.Animation
{
    ...
    public static partial class Easing
    {
        ...
        public static class Quadratic
        {
            ...
            {
                var newPercentage = percentage_ * percentage_;
            ...
            {
                var newPercentage = 1f - (1f - percentage_) * (1f - percentage_);
                return Linear.None(newPercentage, start_, end_);
            }
            ...
            {
                var newPercentage = percentage_ < 0.5f ? 2f * percentage_ * percentage_ : (float)(1f - Math.Pow(-2f * percentage_ + 2f, 2f) / 2f);
