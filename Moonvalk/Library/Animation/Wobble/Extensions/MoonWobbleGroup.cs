...
namespace Moonvalk.Animation {
	...
	public class MoonWobbleGroup {
		...
		/// </summary>
		public Dictionary<MoonWobbleProperty, IMoonWobbleHandler> WobbleHandlers { get; private set; }
		...
		public MoonWobbleGroup() {
			this.WobbleHandlers = new Dictionary<MoonWobbleProperty, IMoonWobbleHandler>();
		}
		...
		public BaseMoonWobble<Unit> AddWobble<ParentType, Unit>(
		...
		public IMoonWobble<Unit> GetWobble<Unit>(MoonWobbleProperty property_) {
			if (this.WobbleHandlers.ContainsKey(property_)) {
				return this.WobbleHandlers[property_]?.GetWobble<Unit>();
			}
			return null;
		}
