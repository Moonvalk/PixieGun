...
namespace Moonvalk.Animation
{
    ...
    public class MoonWobbleHandler<ParentType> : BaseMoonWobbleHandler<float, MoonWobble, ParentType>
    {
        ...
        /// </param>
        public MoonWobbleHandler(ref ParentType object_, MoonWobbleProperty property_, float percentage_, MoonWobbleParams parameters_, bool start_,
        ...
        {
            Wobble = new MoonWobble();
            Wobble.SetReferences(() => ref _values[0]).SetParameters(parameters_).SetPercentage(percentage_);
