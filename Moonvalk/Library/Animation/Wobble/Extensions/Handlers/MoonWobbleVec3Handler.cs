...
namespace Moonvalk.Animation
{
    ...
    public class MoonWobbleVec3Handler<ParentType> : BaseMoonWobbleHandler<Vector3, MoonWobbleVec3, ParentType>
    {
        ...
        /// </param>
        public MoonWobbleVec3Handler(ref ParentType object_, MoonWobbleProperty property_, Vector3 percentage_, MoonWobbleParams parameters_, bool start_,
        ...
        {
            Wobble = new MoonWobbleVec3();
            Wobble.SetReferences(() => ref _values[0], () => ref _values[1], () => ref _values[2]).SetParameters(parameters_).SetPercentage(percentage_);
