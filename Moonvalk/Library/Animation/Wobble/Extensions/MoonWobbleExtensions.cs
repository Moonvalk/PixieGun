...
namespace Moonvalk.Animation
{
    ...
    public static class MoonWobbleExtensions
    {
        ...
        public static Action GetRemoveAction(Node object_, MoonWobbleProperty property_)
        {
            return () =>
            {
                ...
                if (WobbleGroups.ContainsKey(object_))
                {
                    ...
                    if (group.WobbleHandlers.Remove(property_) && group.WobbleHandlers.Count == 0) WobbleGroups.Remove(object_);
                }
            };
        }
        ...
        public static void ClearAll()
        {
            ...
            {
                foreach (var group in WobbleGroups.Values) group?.Clear();
