...
{
    /// <summary>
    /// Contains extension methods for manipulating Godot.Node2D nodes with animations.
    /// </summary>
    public static class Node2DMoonAnimationExtensions
    {
        ...
        private static TweenType TweenTo<Unit, TweenType>(this Node2D object_, MoonTweenProperty property_, Unit target_, MoonTweenParams parameters_ = null,
            bool start_ = true)
        ...
        private static SpringType SpringTo<Unit, SpringType>(this Node2D object_, MoonSpringProperty property_, Unit target_,
        ...
        private static WobbleType Wobble<Unit, WobbleType>(this Node2D object_, MoonWobbleProperty property_, Unit percentage_,
