...
namespace Moonvalk.Animation
{
    ...
    public static class SpatialMoonAnimationExtensions
    {
        ...
        private static TweenType TweenTo<Unit, TweenType>(this Spatial object_, MoonTweenProperty property_, Unit target_, MoonTweenParams parameters_ = null,
            bool start_ = true)
        ...
        {
            return object_.TweenTo<Vector3, MoonTweenVec3>(MoonTweenProperty.Rotation, target_, parameters_, start_);
        }
        ...
        {
            return object_.TweenTo<Vector3, MoonTweenVec3>(MoonTweenProperty.Scale, target_, parameters_, start_);
        }
        ...
        {
            return object_.TweenTo<Vector3, MoonTweenVec3>(MoonTweenProperty.Position, target_, parameters_, start_);
        }
        ...
        private static SpringType SpringTo<Unit, SpringType>(this Spatial object_, MoonSpringProperty property_, Unit target_,
        ...
        {
            return object_.SpringTo<Vector3, MoonSpringVec3>(MoonSpringProperty.Rotation, target_, parameters_, start_);
        }
        ...
        {
            return object_.SpringTo<Vector3, MoonSpringVec3>(MoonSpringProperty.Scale, target_, parameters_, start_);
        }
        ...
        {
            return object_.SpringTo<Vector3, MoonSpringVec3>(MoonSpringProperty.Position, target_, parameters_, start_);
        }
        ...
        private static WobbleType Wobble<Unit, WobbleType>(this Spatial object_, MoonWobbleProperty property_, Unit percentage_,
        ...
        {
            return object_.Wobble<Vector3, MoonWobbleVec3>(MoonWobbleProperty.Rotation, percentage_, parameters_, start_);
        }
        ...
        {
            return object_.Wobble<Vector3, MoonWobbleVec3>(MoonWobbleProperty.Scale, percentage_, parameters_, start_);
        }
        ...
        {
            return object_.Wobble<Vector3, MoonWobbleVec3>(MoonWobbleProperty.Position, percentage_, parameters_, start_);
        }
