...
namespace Moonvalk.Animation
{
    ...
    public class MoonSpringVec2Handler<ParentType> : BaseMoonSpringHandler<Vector2, MoonSpringVec2, ParentType>
    {
        ...
        /// </param>
        public MoonSpringVec2Handler(ref ParentType object_, MoonSpringProperty property_, Vector2 target_, MoonSpringParams parameters_, bool start_,
        ...
        {
            Spring = new MoonSpringVec2 { StartOnTargetAssigned = start_ };
            Spring.SetReferences(() => ref _values[0], () => ref _values[1]).SetParameters(parameters_);
