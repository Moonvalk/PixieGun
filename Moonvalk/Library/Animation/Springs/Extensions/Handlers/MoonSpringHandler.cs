...
namespace Moonvalk.Animation
{
    ...
    public class MoonSpringHandler<ParentType> : BaseMoonSpringHandler<float, MoonSpring, ParentType>
    {
        ...
        /// </param>
        public MoonSpringHandler(ref ParentType object_, MoonSpringProperty property_, float target_, MoonSpringParams parameters_, bool start_,
        ...
        {
            Spring = new MoonSpring { StartOnTargetAssigned = start_ };
            Spring.SetReferences(() => ref _values[0]).SetParameters(parameters_);
