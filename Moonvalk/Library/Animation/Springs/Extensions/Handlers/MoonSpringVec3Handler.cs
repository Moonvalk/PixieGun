...
namespace Moonvalk.Animation
{
    ...
    public class MoonSpringVec3Handler<ParentType> : BaseMoonSpringHandler<Vector3, MoonSpringVec3, ParentType>
    {
        ...
        /// </param>
        public MoonSpringVec3Handler(ref ParentType object_, MoonSpringProperty property_, Vector3 target_, MoonSpringParams parameters_, bool start_,
            Action onComplete_) : base(ref object_, property_, target_, parameters_, start_, onComplete_)
        {
            // ...
        }
        ...
        {
            Spring = new MoonSpringVec3 { StartOnTargetAssigned = start_ };
            Spring.SetReferences(() => ref _values[0], () => ref _values[1], () => ref _values[2]).SetParameters(parameters_);

            Spring.To(target_).OnUpdate(OnUpdate).OnComplete(() => { onComplete_?.Invoke(); });
        }
    }
}